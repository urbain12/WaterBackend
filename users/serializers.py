...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ('id', 'email','phone', 'is_active', 'is_staff', 'is_admin', 'deleted')
...
class SubscriptionsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Subscriptions
        fields = ['id','CustomerID','System','Category','From','To','changeDate','TotalBalance','InstallmentPeriod','Extra','complete','customer_exception','get_overdue_months','Downpayment','Total','customer_exception']
